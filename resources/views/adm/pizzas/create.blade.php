...
@section('content', 'Create a ' .' '. substr($model, 0, -1))
		...
		{{ csrf_field() }}
		  <div class="row">
		      ...
		      <div class="file-path-wrapper">
		        <input class="file-path validate" autocomplete="off" accept="image/*" type="text">
		      </div>
		    </div>
		    ...
		    <div class="input-field col s12">
		      ...
		      <input id="percent" autocomplete="off" type="number" name="percent" value="{{$percentValue}}" type="tel" class="validate" autocomplete="off">
